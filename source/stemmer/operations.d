...
interface IStemOperation {
  ...
  string get(const string value) immutable pure;
}

///
class Invariant : IStemOperation {
  immutable:
...
///
class ReplaceWord : IStemOperation {
  immutable:
...
///
class ReplaceAfter : IStemOperation {
  immutable:
    immutable(string[2][]) list;
...
///
class ReplacePostfix : IStemOperation {
  immutable:
    immutable(string[2][]) list;
...
///
class InlineReplace : IStemOperation {
  immutable:
    immutable(string[2][]) list;
...
///
class RemovePostfix : IStemOperation {
  immutable:
    immutable(string[]) list;
...
///
abstract class StemOperationFromRegion(T) : IStemOperation {
  immutable:
    size_t region;
  ...
  ///
  class RemovePostifixFromRegion(T) : StemOperationFromRegion!T {
    immutable:
    string[] list;
...
///
class ReplacePostifixFromRegion(T) : StemOperationFromRegion!T {
  immutable:
    string[][] list;
...
///
class ReplaceFromRegion(T) : StemOperationFromRegion!T {
  immutable:
    string[][] list;
...
///
class ReplaceAfterFromRegion(T) : StemOperationFromRegion!T {
  immutable:
    immutable(string[2][]) list;
